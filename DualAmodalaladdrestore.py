...
used_inds1_array = np.load(os.path.join(output_dir, "used_inds1.npz"))
used_inds1_array=used_inds1_array['used_inds1']
used_inds=used_inds1_array.tolist()

visual_links_array1 = np.load(os.path.join(output_dir, "visual_links_array1.npz"))
visual_links_array1 = visual_links_array1['visual_links_array1']
visual_links = visual_links_array1.tolist()
...
train_pair_base=train_pair[0:3000]
...
if os.path.exists(os.path.join(output_dir, "check_model1.tar")):
    # self.model.load_weights(os.path.join(from_dir, "model.ckpt"))
    pretrained_dict = torch.load(os.path.join(output_dir, "check_model1.tar"))['state_dict']
...
torch.save({'state_dict': model.state_dict()}, os.path.join(output_dir, "check_model2.tar"))
visual_links_array = np.array(visual_links, dtype=np.int32)
np.savez(os.path.join(output_dir, "visual_links_array2.npz"), visual_links_array2=visual_links_array)
used_inds_array = np.array(used_inds, dtype=np.int32)
np.savez(os.path.join(output_dir, "used_inds2.npz"), used_inds2=used_inds_array)
