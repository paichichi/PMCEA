...
used_inds2_array=used_inds2_array['used_inds2']
used_inds=used_inds2_array.tolist()

visual_links_array2 = np.load(os.path.join(output_dir, "visual_links_array2.npz"))
visual_links_array2 = visual_links_array2['visual_links_array2']
visual_links = visual_links_array2.tolist()
...
if os.path.exists(os.path.join(output_dir, "check_model2.tar")):
    # self.model.load_weights(os.path.join(from_dir, "model.ckpt"))
    pretrained_dict = torch.load(os.path.join(output_dir, "check_model2.tar"))['state_dict']
